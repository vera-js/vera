...
| `@verajs/directives/query` | <!--size:directives-query.gzip.bytes-->3 132 B<!--/size:directives-query.gzip.bytes--> | `route`, `query`, `list` |
...
| `@verajs/directives/remote` | <!--size:directives-remote.gzip.bytes-->3 420 B<!--/size:directives-remote.gzip.bytes--> | server-driven interactions |
| `@verajs/directives/motion` | <!--size:directives-motion.gzip.bytes-->25 164 B<!--/size:directives-motion.gzip.bytes--> | presets, paint, path, sequence, split |
