...
| `@verajs/directives/sensors` | <!--size:directives-sensors.gzip.bytes-->2 052 B<!--/size:directives-sensors.gzip.bytes--> | environment → state |
...
| `@verajs/directives/motion` | <!--size:directives-motion.gzip.bytes-->18 165 B<!--/size:directives-motion.gzip.bytes--> | presets, easings, paint, path, sequence, split |
