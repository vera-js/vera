...
The DOM renderer for VeraJS — <!--size:renderer.gzip-->4.55 KB<!--/size:renderer.gzip--> gzipped,
...
The entry itself is **<!--size:spread.gzip-->1.54 KB<!--/size:spread.gzip-->** gzipped, and only apps
...
<!--size:tag.gzip-->2.14 KB<!--/size:tag.gzip--> gzipped, which includes `/spread` — the factory
