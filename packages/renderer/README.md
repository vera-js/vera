...
The DOM renderer for VeraJS — <!--size:renderer.gzip-->4.29 KB<!--/size:renderer.gzip--> gzipped,
...
**<!--size:slots.gzip-->2.60 KB<!--/size:slots.gzip-->** gzipped and only apps importing it pay;
