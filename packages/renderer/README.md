...
The DOM renderer for VeraJS — <!--size:renderer.gzip-->4.32 KB<!--/size:renderer.gzip--> gzipped,
...
**<!--size:slots.gzip-->2.84 KB<!--/size:slots.gzip-->** gzipped and only apps importing it pay;
