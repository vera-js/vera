...
they are, and how often. Production is unaffected: the instrumentation sits behind a `__DEV__`
constant the build folds away, and `vera-renderer.min.js` is byte-identical with and without it.
