...
export const MODULES = [
  ...
  { pkg: 'reactivity', dist: 'packages/reactivity/dist/vera-store.min.js', what: 'the standalone store — subscriptions without components' },
  ...
  { pkg: 'computed', dir: 'reactivity', dist: 'packages/reactivity/dist/vera-store-computed.min.js', what: 'memoised derived values' },
  { pkg: 'collections', dir: 'reactivity', dist: 'packages/reactivity/dist/vera-store-collections.min.js', what: 'reactive `Map` and `Set` in a store' },
