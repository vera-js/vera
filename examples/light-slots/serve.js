 ...
 *
 *   node examples/light-slots/serve.js  ->  http://localhost:5178/examples/light-slots/
 */
...
}).listen(PORT, () => console.log(`light-DOM slots: http://localhost:${PORT}/examples/light-slots/`));
