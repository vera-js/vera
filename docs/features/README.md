...
| | Claim | Strength |
| --- | --- | --- |
| [Size](size.md) | <!--size:app.kb-->5.9 KB<!--/size:app.kb--> for a working app — level with Lit, under Preact, 10x under React | **Strong** — measured |
...
- **Not core's standalone size.** Core ships no renderer, so `@verajs/core` on its own cannot put
  ...
  <!--size:app.kb-->5.9 KB<!--/size:app.kb-->.
