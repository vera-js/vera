...
| | Claim | Strength |
| --- | --- | --- |
| [Size](size.md) | <!--size:app.kb-->7.0 KB<!--/size:app.kb--> for a working app — level with Lit, under Preact, 10x under React | **Strong** — measured |
...
> A <!--size:app.kb-->7.0 KB<!--/size:app.kb--> reactive framework on native web components. No build step, no base class, no
...
- **Not core's standalone size.** Core ships no renderer, so `@verajs/core` on its own cannot put
  ...
  <!--size:app.kb-->7.0 KB<!--/size:app.kb-->.
