...
| `@verajs/jsx` | 6 055 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 6 255 B | JSX in the browser with no build — the CodePen path |
