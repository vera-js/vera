...
| `@verajs/jsx` | 3 917 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 4 121 B | JSX in the browser with no build — the CodePen path |
