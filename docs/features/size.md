...
| `@verajs/directives/core` | 5 813 B | the engine — registry, activation, context, delegation (core external) |
| `@verajs/directives/standalone` | 7 129 B | the engine with its own store, for a page running no vera |
