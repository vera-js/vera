...
**A working VeraJS app is about <!--size:app.kb-->6.1 KB<!--/size:app.kb--> gzipped (<!--size:app.bytes-->6 286 B<!--/size:app.bytes-->) — <!--size:app.rank-->6th<!--/size:app.rank--> of
...
| **VeraJS + own renderer** | **6 286 B** | 5.2x |
...
`vera-renderer.min.js` is <!--size:stack.bytes-->6 930 B<!--/size:stack.bytes--> gzipped against the app's <!--size:app.bytes-->6 286 B<!--/size:app.bytes-->, because a bundler
...
VeraJS + own renderer is <!--size:app.bytes-->6 286 B<!--/size:app.bytes--> and requires nothing. That is the price of needing no
...
(<!--size:app.bytes-->6 286 B<!--/size:app.bytes-->) is within ten bytes of Lit
...
| `@verajs/renderer` | 4 040 B | keyed template renderer, refs, `hold` |
