...
**A working VeraJS app is about <!--size:app.kb-->6.2 KB<!--/size:app.kb--> gzipped (<!--size:app.bytes-->6 352 B<!--/size:app.bytes-->) — <!--size:app.rank-->6th<!--/size:app.rank--> of
...
| **VeraJS + own renderer** | **6 352 B** | 5.2x |
...
`vera-renderer.min.js` is <!--size:stack.bytes-->7 166 B<!--/size:stack.bytes--> gzipped against the app's <!--size:app.bytes-->6 352 B<!--/size:app.bytes-->, because a bundler
...
(<!--size:app.static.bytes-->5 283 B<!--/size:app.static.bytes-->) —
<!--size:app.static.underlit-->588 B<!--/size:app.static.underlit--> under Lit.**
...
VeraJS + own renderer is <!--size:app.bytes-->6 352 B<!--/size:app.bytes--> and requires nothing. That is the price of needing no
...
(<!--size:app.bytes-->6 352 B<!--/size:app.bytes-->) is within ten bytes of Lit
...
| `@verajs/renderer` | 4 097 B | keyed template renderer, refs, `hold` |
