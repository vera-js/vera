...
**A working VeraJS app is about <!--size:app.kb-->5.8 KB<!--/size:app.kb--> gzipped (<!--size:app.bytes-->5 904 B<!--/size:app.bytes-->) — <!--size:app.rank-->5th<!--/size:app.rank--> of
...
| Lit | 5 871 B | 4.8x |
| **VeraJS + own renderer** | **5 904 B** | 4.8x |
...
VeraJS + own renderer is <!--size:app.bytes-->5 904 B<!--/size:app.bytes--> and requires nothing. That is the price of needing no
...
(<!--size:app.bytes-->5 904 B<!--/size:app.bytes-->) is within ten bytes of Lit
...
| `@verajs/spread` | 804 B | `${spread(props)}` — runtime-named bindings |
