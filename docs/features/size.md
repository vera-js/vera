...
| `@verajs/jsx` | 5 475 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 5 672 B | JSX in the browser with no build — the CodePen path |
