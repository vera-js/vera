...
(<!--size:styles.gzip-->566 B<!--/size:styles.gzip--> gzipped) back, so the win belongs to apps that do not.
...
| `@verajs/styles` | 566 B | `static styles` adoption, shadow and light DOM |
