...
| `@verajs/jsx` | 5 361 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 5 565 B | JSX in the browser with no build — the CodePen path |
