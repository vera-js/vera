...
| `@verajs/directives/core` | 5 246 B | the engine — registry, activation, context, delegation (core external) |
| `@verajs/directives/standalone` | 6 563 B | the engine with its own store, for a page running no vera |
| `@verajs/directives/expressions` | 2 241 B | the expression tier — arithmetic, comparisons, calls |
| `@verajs/directives/interaction` | 3 256 B | the interaction pack — events, reflections, state |
