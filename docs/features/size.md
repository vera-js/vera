...
**A working VeraJS app is about <!--size:app.kb-->6.5 KB<!--/size:app.kb--> gzipped (<!--size:app.bytes-->6 606 B<!--/size:app.bytes-->) — <!--size:app.rank-->6th<!--/size:app.rank--> of
...
| **VeraJS + own renderer** | **6 606 B** | 5.4x |
...
**<!--size:app.static.kb-->5.4 KB<!--/size:app.static.kb--> gzipped
(<!--size:app.static.bytes-->5 564 B<!--/size:app.static.bytes-->) —
<!--size:app.static.underlit-->307 B<!--/size:app.static.underlit--> under Lit.**
...
VeraJS + own renderer is <!--size:app.bytes-->6 606 B<!--/size:app.bytes--> and requires nothing. That is the price of needing no
...
(<!--size:app.bytes-->6 606 B<!--/size:app.bytes-->) is within ten bytes of Lit
