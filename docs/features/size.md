...
| `@verajs/directives/core` | 5 310 B | the engine — registry, activation, context, delegation (core external) |
| `@verajs/directives/standalone` | 6 623 B | the engine with its own store, for a page running no vera |
