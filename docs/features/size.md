...
| `@verajs/jsx` | 3 753 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 3 959 B | JSX in the browser with no build — the CodePen path |
