...
| `@verajs/jsx` | 5 449 B | the JSX transform + Vite plugin — build-time, never shipped to a page |
| `@verajs/jsx/standalone` | 5 654 B | JSX in the browser with no build — the CodePen path |
