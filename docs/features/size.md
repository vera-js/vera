...
**A working VeraJS app is about <!--size:app.kb-->5.5 KB<!--/size:app.kb--> gzipped (<!--size:app.bytes-->5 626 B<!--/size:app.bytes-->) — <!--size:app.rank-->4th<!--/size:app.rank--> of
...
| **VeraJS + own renderer** | **5 626 B** | 4.6x |
| Lit | 5 871 B | 4.8x |
...
VeraJS + own renderer is <!--size:app.bytes-->5 626 B<!--/size:app.bytes--> and requires nothing. That is the price of needing no
...
(<!--size:app.bytes-->5 626 B<!--/size:app.bytes-->) is below Lit (<!--size:app.lit.bytes-->5 871 B<!--/size:app.lit.bytes-->) and
...
| `@verajs/spread` | 628 B | `${spread(props)}` — runtime-named bindings |
