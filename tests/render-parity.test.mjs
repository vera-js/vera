...
const CASES = {
   ...
   *
   * `view`, `route`, `autoloader`, `slot` and `data-vm-sheet` all mean something to a Vera module, and
  ...
  'a spread attribute given false': 'html`<b ${spread({ title: false })}>x</b>`',
  'a spread attribute given zero': 'html`<b ${spread({ title: 0 })}>x</b>`',
  'a spread attribute given an empty string': 'html`<b ${spread({ title: "" })}>x</b>`',
  'a spread attribute given true': 'html`<b ${spread({ title: true })}>x</b>`',
  'a value property given false': 'html`<input .value=${false} />`',
  'a value property given true': 'html`<input .value=${true} />`',
  'a spread .value given false': 'html`<input ${spread({ ".value": false })} />`',
  'a spread .value given true': 'html`<input ${spread({ ".value": true })} />`',
