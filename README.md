...
| --- | ---: | ---: |
| `@verajs/core` | 6.57 KB | **2.87 KB** |
| `@verajs/renderer` | 9.51 KB | 3.74 KB |
| `@verajs/router` | 8.39 KB | 3.59 KB |
| `@verajs/autoloader` | 2.37 KB | 1.19 KB |
| `@verajs/styles` | 1.17 KB | 638 B |
| `@verajs/renderer/spread` | 1.54 KB | 842 B |
| `@verajs/renderer/tag` | 2.72 KB | 1.41 KB |
| `@verajs/reactivity/computed` | 298 B | 241 B |
| `@verajs/reactivity/collections` | 1 007 B | 528 B |
| `@verajs/renderer/keyed` | 1.13 KB | 581 B |
...
<!--size:app.kb-->5.9 KB<!--/size:app.kb--> is quoted for core *plus* a renderer rather than for core alone.
