...
| --- | ---: | ---: |
| `@verajs/core` | 6.84 KB | **3.00 KB** |
| `@verajs/renderer` | 11.19 KB | 4.32 KB |
| `@verajs/router` | 9.52 KB | 3.98 KB |
| `@verajs/autoloader` | 2.81 KB | 1.36 KB |
| `@verajs/styles` | 1.39 KB | 757 B |
| `@verajs/renderer/spread` | 2.36 KB | 1.20 KB |
| `@verajs/renderer/tag` | 3.54 KB | 1.78 KB |
| `@verajs/reactivity/computed` | 298 B | 241 B |
| `@verajs/reactivity/collections` | 1.07 KB | 576 B |
| `@verajs/renderer/keyed` | 1.96 KB | 923 B |
| `@verajs/renderer/slots` | 8.60 KB | 3.22 KB |
| `@verajs/inserts` | 486 B | 357 B |
<!--/size:table.modules-->

A typical app — core plus a renderer, bundled and tree-shaken — is **about <!--size:app.kb-->6.5 KB<!--/size:app.kb--> gzipped**. For
...
<!--size:app.kb-->6.5 KB<!--/size:app.kb--> is quoted for core *plus* a renderer rather than for core alone.
...
<!--size:module.renderer-slots.kb-->3.22 KB<!--/size:module.renderer-slots.kb--> gzipped and entirely
